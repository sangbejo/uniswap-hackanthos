  ...
  try {
    ...
    console.log(
      `Congrats - you've just created a money stream!
        ...
        Network: Kovan
        Super Token: DAIx
        Sender: 0x2D815240A61731c75Fa01b2793E1D3eD09F289d0
        Receiver: ${recipient},
        FlowRate: ${flowRate}
        `
    )
...
async function approve(provider, address, recipient, approveAmount) {
  ...
  try {
    ...
    await token.approve(recipient, ethers.utils.parseEther(approveAmount.toString())).then(function (tx) {
      console.log(
...
export async function streamTokens(
  ...
  var createFlowOperation = sf.cfaV1.createFlow({
    ...
    //receiver: '0x2D815240A61731c75Fa01b2793E1D3eD09F289d0',
